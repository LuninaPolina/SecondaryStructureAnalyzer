# -*- coding: utf-8 -*-
"""model1_pseudoknots.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1uJQXHCh8G7mjWipruXeA5WXJAfraVRVv
"""
...
from keras.layers import Conv2D, MaxPooling2D, Reshape, Input, multiply, LeakyReLU, add 
...
input_train = '/content/in/train/'
input_valid = '/content/in/valid/'
output_train = '/content/out/train/'
output_valid = '/content/out/valid/'
...
ch_p = ModelCheckpoint('/content/best_weights.h5', save_best_only=True, save_weights_only=True, 
                       monitor='val_f_mera', mode='max')
...
model.save_weights('/content/weights2.h5')
