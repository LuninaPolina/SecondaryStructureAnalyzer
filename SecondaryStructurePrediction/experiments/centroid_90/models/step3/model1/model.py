...
input_train = '/home/polina/1tb/ss_prediction/centroid_90/redone/data/in/train/'
input_valid = '/home/polina/1tb/ss_prediction/centroid_90/redone/data/in/valid/'
output_train = '/home/polina/1tb/ss_prediction/centroid_90/redone/data/out/train/'
output_valid = '/home/polina/1tb/ss_prediction/centroid_90/redone/data/out/valid/'
...
model1.load_weights('/home/polina/1tb/ss_prediction/centroid_90/redone/models_steps/step1/model2/weights.h5') 
weights1 = [layer.get_weights() for layer in model1.layers]

model2 = res_network(5, [12,10,8,6,1]) #predicted -> aligned
model2.load_weights('/home/polina/1tb/ss_prediction/centroid_90/redone/models_steps/step2/model1/weights.h5')
...
for j in range(len(weights2)):
    ...
    #if j < 52:
       # model.layers[i + j].trainable = False
coeff = 7
 
def weighted_acc_loss(y_true, y_pred):
...
def comb_loss(y_true, y_pred):
    return l1 * weighted_acc_loss(y_true, y_pred) + l2 * f_mera_loss(y_true, y_pred)
...
ch_p = ModelCheckpoint('/home/polina/1tb/ss_prediction/centroid_90/redone/models_steps/step3/model1/best_weights.h5', save_best_only=True, save_weights_only=True, monitor='val_loss', mode='min')
...
csv_logger = CSVLogger('/home/polina/1tb/ss_prediction/centroid_90/redone/models_steps/step3/model1/training.log')
...
model.save_weights('/home/polina/1tb/ss_prediction/centroid_90/redone/models_steps/step3/model1/weights.h5')
